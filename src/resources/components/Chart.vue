            ...
            if (this.chartData.datasets) {
                if (this.type === 'bar') {
                    ...
                    for (let index = 0; index < this.chartData.datasets.length; index++) {
                        ...
                        if (typeof dataset.backgroundColor === 'undefined' || dataset.backgroundColor === 'auto') {
        ...
        chartData: function(newValue, oldValue) {
            if (this.chartData !== null && this.chartData !== undefined) {
                ...
                if ( ! Object.is(newValue.datasets, oldValue.datasets)) {
                    ...
                    if (newValue.datasets.length === oldValue.datasets.length || oldValue.datasets.length === 0 && newValue.datasets.length > 0) {
