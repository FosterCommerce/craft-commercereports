    ...
    <div class="commerce-insights-date-range-picker" v-click-outside="closeAll">
        <div class="commerce-insights-menu">
            <div class="inline-block w-4 h-4">
                <svg class="w-full h-auto" height="14" width="13" viewBox="0 0 13 14" xmlns="http://www.w3.org/2000/svg"><path d="m3.95652174 1.68h5.08695652v-1.68h1.13043474v1.68h2.2608696c.3125652 0 .5652174.25144.5652174.56v1.12h-13v-1.12c0-.30856.25321739-.56.56521739-.56h2.26086957v-1.68h1.13043478zm-2.82608696 11.2h2.26086957v-2.24h-2.26086957zm0-2.8h2.26086957v-2.24h-2.26086957zm0-2.8h2.26086957v-2.24h-2.26086957zm2.82608696 5.6h2.26086956v-2.24h-2.26086956zm0-2.8h2.26086956v-2.24h-2.26086956zm0-2.8h2.26086956v-2.24h-2.26086956zm2.82608696 5.6h2.26086956v-2.24h-2.26086956zm0-2.8h2.26086956v-2.24h-2.26086956zm0-2.8h2.26086956v-2.24h-2.26086956zm2.82608695 5.6h2.26086955v-2.24h-2.26086955zm0-2.8h2.26086955v-2.24h-2.26086955zm0-2.8h2.26086955v-2.24h-2.26086955zm-9.60869565 6.16v-9.52h13v9.52c0 .30968-.2526522.56-.5652174.56h-11.86956521c-.312 0-.56521739-.25032-.56521739-.56z" fill="#1e2732" fill-rule="evenodd"/></svg>
            </div>
            <div class="inline-block leading-none ml-4 cursor-pointer" 
                v-bind:class="{ 'text-gray-500': rangeIsCustom }"
            >
                {{ selectedLabel }}
            </div>
            <!--<a class="btn submit text-xs inline-block ml-4 cursor-pointer"
                v-if="rangeIsCustom"
            ...
            <div v-on:click="toggleMenu" class="toggle-menu">
                ...
                <div v-if="menuOpen" class="menu commerce-insights-presets" style="display: block;">
                    <ul role="listbox" aria-hidden="true">
                        <li v-for="(settings, key) in defaultPresets" :key="key" class="commerce-insights-preset">
...
export default {
    ...
    methods: {
        ...
        savePreset() {
            ...
            axios.post('/actions/commerceinsightscomponents/vue/save-preset')
        ...
        fetchSavedPresets() {
            ...
            axios.get('/actions/commerceinsightscomponents/vue/get-presets')
                .then(function(response){
