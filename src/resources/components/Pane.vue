<template>
    <div v-cloak class="commerce-insights-pane" :class="{ 'flush-top': flushTop, 'vertical-center': centerVertically, 'is-flex': flex }">
        <div v-if="title" class="commerce-insights-pane-title">
            ...
            <div v-if="trend" class="relative" style="top: -2px;">
                <div class="commerce-insights-trend" :class="{ 'up': positiveTrend, 'down': ! positiveTrend }">
                    {{ trend }}
                </div>
            </div>
        </div>
